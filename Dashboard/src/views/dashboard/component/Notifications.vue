          ...
          <v-row>
            ...
            >
              <div>
                ...
                <div class="grey--text">
                  The first step is to create an account at <a href="#">Creative Tim</a>. You can choose a social network or go for the classic version, whatever works best for you.
                </div>
              </div>
            </v-col>
